...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2020 at 01:05 PM
...
ALTER TABLE `produktai_medziagos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `produktai_medziagos_ibfk_1` (`id_medziagos`),
  ADD KEY `produktai_medziagos_ibfk_2` (`id_produkto`);
...
--
ALTER TABLE `produktai_medziagos`
  ADD CONSTRAINT `produktai_medziagos_ibfk_1` FOREIGN KEY (`id_medziagos`) REFERENCES `maistines_medz` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `produktai_medziagos_ibfk_2` FOREIGN KEY (`id_produkto`) REFERENCES `produktai` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
